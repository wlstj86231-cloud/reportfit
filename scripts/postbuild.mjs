...
const pages = [
  {
    slug: "about",
    title: "대학생 도우미 소개",
    description: "대학생 도우미는 과제를 대신 작성하지 않고 제출 전 파일 변환과 문서 정리를 돕는 브라우저 기반 도구입니다."
  },
  {
    slug: "privacy",
    title: "개인정보 처리방침 - 대학생 도우미",
    description: "대학생 도우미의 파일 처리 기능과 개인정보 처리 기준을 안내합니다."
  },
  {
    slug: "terms",
    title: "이용안내 - 대학생 도우미",
    description: "대학생 도우미 사용 범위, 제출 전 확인 기준, 도구 결과의 한계를 안내합니다."
  },
  {
    slug: "contact",
    title: "문의 - 대학생 도우미",
    description: "대학생 도우미 오류, 기능 건의, 과제 제출 도구 개선 의견을 보내는 방법을 안내합니다."
  },
  {
    slug: "editorial",
    title: "편집 기준 - 대학생 도우미",
    description: "대학생 도우미가 과제 제출 전 파일과 형식 정리 도구를 구성하는 기준을 설명합니다."
  },
  {
    slug: "review-readiness",
    title: "승인 준비 체크 - 대학생 도우미",
    description: "대학생 도우미의 기능, 독립 페이지, 고유 설명 문서, 광고 심사 준비 기준을 정리합니다."
  }
];

const homeMeta = {
  title: "대학생 도우미 - 과제 제출용 PDF, 이미지, 파일 정리 도구",
  description: "대학생 도우미는 PDF 압축, 이미지 변환, 파일명 만들기, 글자수 계산, 참고문헌 정리, ZIP 압축을 브라우저에서 빠르게 처리하는 과제 제출 도구입니다.",
  route: "",
  kind: "home"
};
        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: {
              "@type": "Answer",
              text: "대학생 도우미의 주요 파일 처리 기능은 사용자의 브라우저 안에서 실행되도록 구성되어 있습니다. 다만 최종 제출 전에는 결과 파일을 직접 열어 확인하는 것이 좋습니다."
            }
          },
          {
            "@type": "Question",
...
function cleanTitle(title) {
  return title.replace(" - 대학생 도우미", "").replace(/^대학생 도우미 - /, "대학생 도우미");
}
